...
namespace Tyuiu.BushlyaYaV.Sprint5.Task5.V18
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("* Дан файл С:\\DataSprint5\\InPutDataFileTask5V18.txt (файл взять из архива  *");
            Console.WriteLine("* согласно вашему варианту. Создать папку в ручную С:\\DataSprint5\\ и      *");
            Console.WriteLine("* скопировать в неё файл) в котором набор значений. Найти произведение    *");
            Console.WriteLine("* всех двузначных чисел в файле. Полученный результат вывести на консоль. *");
